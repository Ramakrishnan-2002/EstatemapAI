...
STORIES_DATA = [
    ...
    (51, "LLM Integration Patterns: RAG vs Function Calling vs State Machines", 5, 7, [4], [52, 55, 65],
     ...
     "LLM architecture comparison: RAG vs Tool Calling vs State Machines", "docs/mastery/CANONICAL_ARCHITECTURE_TRUTH.md", STATUS_THEORY,
    ...
    (85, "CI/CD Pipeline Automation (GitHub Actions Testing Matrix)", 5, 9, [81, 84], [86, 88],
     ...
     "CI/CD automated test runner & container registry push", "docs/mastery/CANONICAL_ARCHITECTURE_TRUTH.md", STATUS_FUTURE,
    ...
    (87, "Ephemeral Integration Testing with Testcontainers", 5, 9, [86], [88, 89],
     ...
     "Ephemeral PostgreSQL + Redis containers per test session", "docs/mastery/CANONICAL_ARCHITECTURE_TRUTH.md", STATUS_FUTURE,
    ...
    (89, "Structured JSON Telemetry & Prometheus Metric Exporters", 5, 9, [6, 48, 82], [90, 94],
     ...
     "Hypothetical Prometheus /metrics endpoint", "docs/mastery/CANONICAL_ARCHITECTURE_TRUTH.md", STATUS_FUTURE,
    ...
    (90, "Distributed Tracing & OpenTelemetry APM Instrumentation", 5, 9, [6, 89], [94, 96],
     ...
     "W3C Trace Context propagation across HTTP, Redis, and DB calls", "docs/mastery/CANONICAL_ARCHITECTURE_TRUTH.md", STATUS_FUTURE,
    ...
    (91, "Modular Monolith vs Microservices Architecture Tradeoffs", 8, 10, [1, 8, 9, 39], [92, 95, 99],
     ["backend/app/main.py", "docs/mastery/CANONICAL_ARCHITECTURE_TRUTH.md"],
    ...
    (92, "Database Sharding & Read Replica Topology for Spatial Workloads", 8, 10, [9, 23, 28, 91], [93, 95],
     ...
     "PostgreSQL primary-replica replication & spatial shard routing", "docs/mastery/CANONICAL_ARCHITECTURE_TRUTH.md", STATUS_FUTURE,
    ...
    (93, "Distributed Redis Cluster & Geo-Replication Topologies", 8, 10, [39, 41, 50, 91], [94, 96],
     ...
     "Redis Cluster 16384 hash slot partitioning & geo-replication", "docs/mastery/CANONICAL_ARCHITECTURE_TRUTH.md", STATUS_FUTURE,
    ...
    (94, "High-Throughput AI Gateway & LLM Inference Queueing", 8, 10, [52, 57, 58, 91], [95, 97],
     ...
     "Asynchronous task queues (Celery/RabbitMQ) for batch LLM inference", "docs/mastery/CANONICAL_ARCHITECTURE_TRUTH.md", STATUS_FUTURE,
    ...
    (95, "Event-Driven Architecture with Kafka / CDC Ingestion", 8, 10, [18, 42, 91], [96, 97],
     ...
     "Debezium CDC streaming property updates to Kafka topic", "docs/mastery/CANONICAL_ARCHITECTURE_TRUTH.md", STATUS_FUTURE,
    ...
    (96, "Real-Time WebSocket Viewport Synchronization at 100K CCU", 8, 10, [76, 77, 91], [97],
     ...
     "WebSocket server broadcasting viewport property updates", "docs/mastery/CANONICAL_ARCHITECTURE_TRUTH.md", STATUS_FUTURE,
    ...
    (97, "Multi-Region Active-Active Disaster Recovery & Edge Routing", 8, 10, [50, 92, 93, 95], [98, 100],
     ...
     "Anycast DNS routing, cross-region replication, and failover", "docs/mastery/CANONICAL_ARCHITECTURE_TRUTH.md", STATUS_FUTURE,
    ...
    (98, "Zero-Trust Security Architecture & Secrets Vault Integration", 5, 10, [14, 15, 17, 91], [99, 100],
     ...
     "mTLS service communication and dynamic short-lived credentials", "docs/mastery/CANONICAL_ARCHITECTURE_TRUTH.md", STATUS_FUTURE,
    ...
    (99, "EstateMap Architectural Decision Records (ADRs) & Tradeoffs", 5, 10, [91, 92, 93, 94, 95], [100],
     ...
     "ADR Catalog: Modular Monolith, PostGIS, Multi-Provider AI, MapLibre, Redis", "docs/mastery/CANONICAL_ARCHITECTURE_TRUTH.md", STATUS_CURRENT,
    ...
    (100, "End-to-End System Design Whiteboard Defense & Mastery Synthesis", 8, 10, [91, 99], [],
     ["docs/mastery/CANONICAL_ARCHITECTURE_TRUTH.md", "docs/mastery/ENGINEERING_STORIES.md"],
